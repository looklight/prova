...
const CookieBanner: React.FC<CookieBannerProps> = ({ onAccept, onReject }) => {
  ...
  return (
    <>
      {!showDetails ? (
        // ========== VISTA ULTRA-MINIMALE (1 RIGA FISSA) ==========
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50">
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center justify-between gap-4 flex-wrap">
              {/* Testo + Icona */}
              <div className="flex items-center gap-3 flex-1 min-w-0">
                <Cookie size={20} className="text-blue-500 flex-shrink-0" />
                <p className="text-xs text-gray-700">
                  Utilizziamo cookie essenziali e analitici (opzionali).{' '}
                  <a href="/cookies" className="text-blue-500 hover:underline font-medium">
                    Info
                  </a>
                </p>
              </div>
        ...
        // ========== VISTA DETTAGLIATA (ESPANSA) ==========
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-gray-200 shadow-2xl z-50 max-h-[70vh] overflow-y-auto">
